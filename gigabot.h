...
#define GIGA_BUILD_VERSION "4.2.4 RC3MF"
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 118.52, 118.52, 4031.5, 65 }
  ...
  #define DEFAULT_XJERK                 20.0 // was 9
  #define DEFAULT_YJERK                 20.0 // was 9
#endif
...
//===========================================================================
  ...
  #define THERMAL_PROTECTION_PERIOD 180        // was 80 Seconds
  #undef  THERMAL_PROTECTION_HYSTERESIS 
  #define THERMAL_PROTECTION_HYSTERESIS 12  	// was 8 deg
