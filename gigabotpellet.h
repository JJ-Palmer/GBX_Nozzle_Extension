...
#undef MSG_GIGABOT3
#define MSG_GIGABOT3 "Gigabot X Reg"
#undef GIGA_BUILD_VERSION
#define GIGA_BUILD_VERSION "Nozzle Extension"
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 106.67, 118.52, 4031.5, 65 }
  ...
  #define HEATER_2_PIN    4   // HE5 on board
  #define HEATER_3_PIN    11   // HE8 on board
